...
public class TestPet {
    ...
    public void testPostPet() throws IOException {
        ...
        .log().all() // mostre tudo na volta
                ...
                .body("status", is(status[0])) // status do pet na loja
        ; // fim do given
    ...
    public void testGetPet() throws InterruptedException {
        ...
        // Entrada e Saidas definidas no nível da classe        
         await()
            .atMost(30, TimeUnit.SECONDS)   // tempo máximo de espera
            .pollInterval(5, TimeUnit.SECONDS) // intervalo de tentativas
            .untilAsserted(() -> {
                given()                
                        .contentType(ct)
                        .log().all()
    ...
    public void testPostPetDDT(
            ...
            String catName,
            String status1,
            String status2) // fim dos parametros
